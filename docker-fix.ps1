...
function Restart-DockerDesktop {
    ...
    if (Test-DockerDesktop) {
        Write-Host "✅ Docker Desktop è ora disponibile!" -ForegroundColor Green
        return $true
    } else {
...
function Reset-DockerNetwork {
    ...
    try {
        ...
        Write-Host "⚠️  Errore durante il reset della rete: $_" -ForegroundColor Red
    }
}
...
function Clear-DockerCache {
    ...
    try {
        ...
        Write-Host "⚠️  Errore durante la pulizia: $_" -ForegroundColor Red
    }
}
...
do {
    ...
    switch ($choice) {
        ...
        default {
            Write-Host "⚠️  Scelta non valida!" -ForegroundColor Red
        }
    }
